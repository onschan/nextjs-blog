      ...
      <div css={styles.container}>
        <section css={styles.section}>
          <h1 css={styles.title}>
            안녕하세요.
            <br />
            프론트엔드 개발자 <strong>온승찬</strong>입니다.
          </h1>
          <p>
            4년차 프론트엔드 개발자로, 이커머스 SaaS 환경에서 백오피스와 웹빌더 제품을 개발하고
            운영해왔습니다. React, Next.js, TypeScript 기반으로 주문, 상품, 연동 상품, 웹빌더 에디터
            등 복잡한 커머스 도메인의 사용자 흐름을 제품 경험으로 풀어내는 데 강점이 있습니다.
          </p>
          <p>
        ...
        <section css={styles.section}>
          <h2 css={styles.heading}>Work Experience &amp; Project</h2>
          ...
          <div css={styles.content}>
            ...
            <div css={styles.contentBody}>
              <div css={styles.meta}>
                <p>
                  <span css={styles.metaLabel}>사용 기술</span>
                  Next.js, TypeScript, Recoil, React Query, Styled-components, Nx, Module
                  Federation, WebSocket
                </p>
                <p>
                  <span css={styles.metaLabel}>환경</span>
                  Nx 기반 20개 이상 애플리케이션으로 구성된 이커머스 SaaS 모노레포
                </p>
              </div>
              <ul css={styles.list}>
                <li css={styles.listItem}>
                  ...
                  <ul css={styles.list}>
                    <li>
                      서비스 초기 개발 단계부터 참여하여 주문, 상품, 연동 상품, 웹빌더 에디터 등
                      핵심 도메인의 프론트엔드 개발과 운영을 담당했습니다.
                    </li>
                    <li>
                      사용자가 실제로 상품을 등록하고, 웹사이트를 편집하고, 주문을 처리하는 업무
                      흐름을 기준으로 화면 구조와 인터랙션을 설계했습니다.
                    </li>
                    <li>
                      PM·디자이너·백엔드 엔지니어와 협업하여 요구사항을 기술 구조로 구체화했고,
                      사용자 피드백과 행동 데이터를 기반으로 UX 개선을 반복했습니다.
                    </li>
                    <li>
                      매출·결제율 개선에 대한 아이디어를 적극적으로 제안하며 실제 성과로 이어진
                      경험이 있습니다.
                    </li>
                  </ul>
                </li>
                <li css={styles.listItem}>
                  ...
                  <ul css={styles.list}>
                    <li>
                      ...
                      온페이지 D&amp;D 구조로 전환하는 작업을 주도했습니다.
                    </li>
                    <li>
                      iframe 환경에서 부모 앱과 프리뷰 영역 간 이벤트 흐름이 분리되는 문제를
                      postMessage 기반 이벤트 동기화 구조를 개선해 해결했습니다.
                    </li>
                    <li>
                      empty container 처리, cross-section 이동, depth 제한, width 재분배 등 복잡한
                      편집 엣지 케이스를 안정적으로 처리할 수 있도록 상태 구조와 이벤트 흐름을
                      개선했습니다.
                    </li>
                  </ul>
                </li>
                <li css={styles.listItem}>
                  ...
                  <ul css={styles.list}>
                    ...
                    <li>
                      ...
                      주요 입력 인터랙션 기준 INP를 600ms 이상에서 60ms 이하로 개선했습니다.
                    </li>
                    <li>
                      개선 방식을 팀에 공유하여 유사한 대규모 폼 데이터 관리 상황에서도 재사용
                      가능한 패턴으로 정착시켰습니다.
                    </li>
                  </ul>
                </li>
                <li css={styles.listItem}>
                  ...
                  <ul css={styles.list}>
                    <li>
                      외부 협력사 앱이 스토어매니저 안에서 네이티브 UI로 기능을 제공할 수 있도록
                      하는 확장 스크립트 시스템을 전담하여 설계하고 구현했습니다.
                    </li>
                    <li>
                      외부 개발자가 스크립트만 등록하면 런타임에 모달, 스낵바, 액션 버튼, 입력 필드
                      등 내부 UI를 제어할 수 있는 JavaScript API 인터페이스를 설계했습니다.
                    </li>
                    <li>
                      스토어·사용자 인증 정보 등 앱 동작에 필요한 컨텍스트를 외부 스크립트에
                      안전하게 전달하고, iframe 기반 앱 화면과 통신하는 구조를 구현했습니다.
                    </li>
                    <li>
                      내부 제품 코드와 외부 확장 기능의 경계를 명확히 분리하여, 협력사가 늘어나도
                      제품 코드 수정 없이 기능을 확장할 수 있는 구조를 만들었습니다.
                    </li>
                  </ul>
                </li>
                <li css={styles.listItem}>
                  ...
                  <ul css={styles.list}>
                    <li>
                      ...
                      20개 이상 도메인의 독립 애플리케이션으로 점진적으로 분리하고 운영하는 구조에
                      참여했습니다.
                    </li>
                    <li>
                      각 도메인이 독립적으로 개발·배포될 수 있도록 애플리케이션 경계를 나누고, 공통
                      UI·유틸·인증 의존성을 중앙화했습니다.
                    </li>
                    <li>
                      도메인별 자율성과 전체 제품의 일관성을 함께 유지할 수 있는 프론트엔드 구조를
                      운영했고, 주요 워크플로우 기준 빌드 시간을 20분에서 2분 이내로 단축했습니다.
                    </li>
                  </ul>
                </li>
                <li css={styles.listItem}>
                  ...
                  <ul css={styles.list}>
                    <li>
                      ...
                      전달하는 이벤트 처리 구조를 만들었습니다.
                    </li>
                    <li>
                      Web Push 연동을 통해 주문, 문의, 시스템 이벤트 등 주요 이슈를 브라우저
                      알림으로 전달하는 기능을 새롭게 만들었습니다.
                    </li>
                    <li>
                      실시간 데이터 반영, 알림 상태, 사용자 피드백 처리를 고려하여 운영성 있는
                      이벤트 기반 UI를 구현했고, 백오피스 사용자가 중요한 이벤트를 더 빠르게 인지할
                      수 있도록 했습니다.
                    </li>
                  </ul>
                </li>
                <li css={styles.listItem}>
                  ...
                  <ul css={styles.list}>
                    <li>
                      ...
                      보조, 반복 업무 자동화 등 개발 워크플로우 전반에 적용하고 있습니다.
                    </li>
                    <li>
                      AI 결과물을 그대로 사용하는 것이 아니라, 현재 코드베이스의 제약과 운영 맥락을
                      기준으로 검증하고 실제 개발 프로세스에 통합하는 방식으로 활용하고 있습니다.
                    </li>
                    <li>
                      프로젝트별 AGENTS.md, 협업 가드레일, 검증 기준을 정리해 AI가 작업 맥락을
                      놓치지 않도록 관리하고 있습니다.
                    </li>
                    <li>
                      팀 AI 활용 워크숍을 주도하고, AI 지침·Agent 활용법·하네스 엔지니어링 사례를
                      정리해 공유하며 팀 전체의 AI 활용도를 높이고 있습니다.
                    </li>
                  </ul>
                </li>
              </ul>
          ...
          <div css={styles.content}>
            ...
            <div css={styles.contentBody}>
              ...
              <ul css={styles.list}>
                ...
                <li>Lighthouse 성능 점수를 40점대에서 80점대 후반으로 개선했습니다.</li>
                <li>
                  Polling, SSE, WebSocket의 트레이드오프를 비교하며 실시간 동기화 구조를
                  개선했습니다.
                </li>
                <li>Webpack, Babel, Cypress 기반 개발/테스트 환경을 구성했습니다.</li>
                <li>
                  CI/CD 파이프라인에 E2E 테스트를 연동하여 주요 사용자 플로우의 회귀 테스트 기반을
                  마련했습니다.
                </li>
              </ul>
            </div>
        ...
        <section css={styles.section}>
          ...
          <div css={styles.content}>
            ...
            <ul css={styles.list}>
              <li>30명 이상 수강생을 대상으로 코드 리뷰와 페어 프로그래밍을 진행했습니다.</li>
              <li>
                단순한 정답 제시보다, 리뷰이가 스스로 구조적 문제를 발견하고 개선 방향을 잡을 수
                있도록 질문과 피드백 중심으로 리뷰를 진행했습니다.
              </li>
            </ul>
          </div>
          ...
          <div css={styles.content}>
            ...
            <ul css={styles.list}>
              <li>5명 이상 수강생을 대상으로 코드 리뷰와 페어 프로그래밍을 진행했습니다.</li>
            </ul>
          </div>
        ...
        <section css={styles.section}>
          ...
          <div css={styles.content}>
            <div css={styles.contentTitle}>
              <h3 css={styles.subheading}>Article</h3>
            </div>
            <ul css={styles.list}>
              <li css={styles.listItem}>
                <strong>
                  <Link href="/post/react-fiber" css={styles.inlineLink}>
              ...
              <li css={styles.listItem}>
                <strong>
                  <Link href="/post/mf" css={styles.inlineLink}>
                    Module Federation 이해하기
                  </Link>
                </strong>
                <ul css={styles.list}>
                  <li>
                    실무에 적용한 기술 스택을 딥다이브 학습하며 동작 원리와 제약사항까지 정리해
                    공유했습니다.
                  </li>
                </ul>
              </li>
          ...
          <div css={styles.content}>
            <div css={styles.contentTitle}>
              <h3 css={styles.subheading}>Presentation</h3>
            </div>
            <ul css={styles.list}>
              <li css={styles.listItem}>
                <strong>[10분 테코톡] 온스타의 상태관리</strong>
                <ul css={styles.list}>
                  <li>프론트엔드 상태관리를 주제로 발표했습니다.</li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <div css={styles.content}>
            ...
            <ul css={styles.list}>
              <li>React 공식 문서 한국어 번역에 참여했습니다.</li>
            </ul>
          </div>
        </section>
